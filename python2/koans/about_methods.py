...
class AboutMethods(Koan):
    ...
    def test_calling_functions_with_wrong_number_of_arguments(self):
        try:
            ...
            # into a string value.
            self.assertEqual( r'my_global_function\(\) missing 2 required positional arguments', exception.__class__.__name__)
            self.assertMatch(
        ...
        try:
            ...
            self.assertMatch(r'my_global_function\(\) takes 2 positional arguments but 3 were given', e[0])
    ...
    def test_calling_with_default_values(self):
        self.assertEqual(1, self.method_with_defaults(1))
